...
export function Projects() {
  ...
  const projects = [
    ...
    {
      image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZXJuIHN0YWNrIHdlYiUyMGFwcHxlbnwxfHx8fDE3NjgzODAwMjN8MA&ixlib=rb-4.1.0&q=80&w=1080',
      title: 'EquiLife – MERN Stack DevOps Enabled Web Application',
      description: 'A full-stack MERN application with DevOps integration, featuring CI/CD pipelines, Docker containerization, and automated workflows for scalable and efficient deployment.',
      fullDescription: 'EquiLife is a full-stack Final Year Project developed using the MERN stack (MongoDB, Express.js, React, Node.js), focusing on scalable and maintainable system architecture with modern DevOps practices. Built with React (Vite) frontend and Express/MongoDB backend, it features modular development layers and RESTful APIs for seamless communication. Implemented a comprehensive CI/CD pipeline using GitHub Actions that automatically validates code, installs dependencies, runs lint checks, and builds on every push/pull request. The entire application is containerized with Docker and Docker Compose, utilizing multi-stage builds and Nginx to optimize frontend performance in production. Additional features include environment variable management, health check endpoints for monitoring, and a structured Git branching strategy supporting collaborative development. This project showcases real-world software engineering and DevOps best practices with automation, containerization, and deployment-ready architecture.',
      tags: ['React', 'Docker', 'CI/CD Pipeline', 'Node.js', 'MongoDB', 'GitHub Actions', 'Nginx'],
      link: 'https://github.com/muhammadrehman111/',
      github: 'https://github.com/muhammadrehman111/'
    }
  ];
