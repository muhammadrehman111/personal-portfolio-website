      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Passionate about building scalable web applications with the MERN stack. Experienced in crafting responsive frontends, robust backends, and designing efficient databases to deliver seamless user experiences.
            </motion.p>
            ...
            >
              ...
              <motion.button
                ...
                onClick={() => {
                  ...
                  const cvUrl = 'https://drive.google.com/file/d/102z9hbNybZrUznZMGCtdU7Yk4KpU4MD5/view?usp=sharing';
