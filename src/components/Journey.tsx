  ...
  const education = [
    {
      ...
      duration: '2022 – 2026',
      gpa: '3.46 CGPA',
      description: 'Maintained 3.46 CGPA while completing advanced software engineering courses. Developed 5+ MERN-stack & DevOps-related academic projects with real-world applications.'
    },
    {
